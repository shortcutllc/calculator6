                      ...
                      <>
                        <div>
                          ...
                          <select
                            value={
                              resolveMindfulnessEntry({
                                mindfulnessServiceId: service.mindfulnessServiceId,
                                mindfulnessType: service.mindfulnessType,
                                classLength: service.classLength,
                              }).id
                            }
                            onChange={(e) => {
                              const entry = MINDFULNESS_CATALOG_BY_ID[e.target.value];
                              if (!entry) return;
                              updateService(index, {
                            ...
                            className="w-full px-4 py-3 border-2 border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-shortcut-teal focus:border-shortcut-teal"
                          >
                            {MINDFULNESS_SELECT_OPTIONS.map((opt) => (
