...
export const SENDER_TO_CALENDAR: Partial<Record<SenderName, string>> = {
  ...
  'Caren Skutch': 'https://calendar.google.com/calendar/appointments/schedules/AcZssZ1P-Oh9wQEOHZbwvSZTLfzFglXTo9AaIwmrQTYHIqwIlFlIch-VqSneJYcaJqWifF7gDuZsA6xr',
};
