...
${audience === 'brokers'
    ? `AUDIENCE: employee-benefits broker (producer/consultant). This is CHANNEL COURTSHIP, not a pitch — Will wants a relationship where referring Shortcut makes THEM look good. The give, woven in naturally: many of their clients on Cigna/Aetna have carrier wellness dollars they forfeit every plan year, and Shortcut is how clients spend those funds on things employees actually use. Never say "partnership". Never ask for referrals. Close with a peer question (e.g. whether unused wellness funds come up in their renewal conversations).`
