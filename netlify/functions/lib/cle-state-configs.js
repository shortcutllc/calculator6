...
const CLE_STATE_CONFIGS = {
  ...
  PA: { code: 'PA', name: 'Pennsylvania', creditLabel: '1.0 PA Ethics Credit', creditDesc: '1.0 Pennsylvania CLE credit in Ethics', boardName: 'the Pennsylvania CLE Board', abbr: 'PA', rulesName: 'Pennsylvania Rules of Professional Conduct' },
