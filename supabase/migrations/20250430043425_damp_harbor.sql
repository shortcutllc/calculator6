/*
  # Simplify proposal sharing system

  1. Changes
    - Remove all password and expiration related columns
    - Simplify RLS policies for better sharing support
...
-- Remove any remaining password or expiration columns
