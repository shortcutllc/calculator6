...
// classify() + cleanReply() live in netlify/functions/lib/sentiment.js
// (shared by the Smartlead backfill here, the Gmail-pubsub reply tracker,
// and the inbox-crawl — one rule set, no drift).
